...
void testungets(); // 4-7 homework answer: test ungets function;
...
void testungets() { // 4-7 homework answer: test ungets function;
	...
	ungets("hello");
	sbufp = bufp;
	printf("current bufp: %d\n", bufp);
	for(i = 0; i < sbufp; i++)
		printf("result of getch: %c\n", getch());
	printf("current bufp: %d\n", bufp);
}
...
int main() {
	...
	//4-7 homework answer: add logic for test ungets function;
	testungets();
	exit(0);
